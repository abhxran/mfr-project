...
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <title><?php echo $surveyScriptdetail['title']?></title>
    <meta name="description" content="<?php echo $surveyScriptdetail['description']?>" />
...
<link rel="canonical" href="<?php echo $SITE_URL;?>survey-scriptings" />
                    ...
                    <div class="col-md-12 flex-align">
                        <div class=" fadeInRight">
                            <div class="section-headding color-headding">
                                <h1 class="section-topik"><?php if($surveyScriptdetail['h1']<>""){echo $surveyScriptdetail['h1'];} else{echo $surveyScriptdetail['detail_title'];}?></h1>
