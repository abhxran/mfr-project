...
$q = "UPDATE `user` set password='".md5($_POST['password'])."' where id="$_SESSION["id"];

$c = mysqli_query($dbc,$q);
?>
<script>  window.location = "https://www.mindforceresearch.com/contact_login.php?change_password";  </script>
<?php
    ...
    <div class="card card-login mx-auto text-center bg-dark">
        <div class="card-header mx-auto bg-dark">
            <span> <img src="https://www.mindforceresearch.com/images/logo.png" class="w-75" alt="Logo"> </span><br/>
                        <span class="logo_title mt-5"> Change Password</span>
        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <input type="submit" name="btn" value="Change Password" class="btn btn-outline-danger float-right login_btn">
                </div>
